...
const Why_choose_us = () => {
  return (
    <div className="container flex flex-col md:flex-row justify-between mx-auto mb-[100px]">
      <div className="w-full md:w-1/2 flex justify-center order-1 md:order-2 slide-from-left">
        <img
          src={chooseUsImg}
          alt=""
      ...
      <div className="w-full md:w-1/2 flex flex-col mt-5 md:mt-0 leading-[40px] md:leading-[70px] order-2 md:order-1">
        <h2 className="font-[400] text-blue-700 text-[18px] md:text-[28px] ml-2 md:ml-0 mr-2 md:mr-0 slide-from-left">
          Why Choose Us
        </h2>
        <h1 className="text-[32px] md:text-[64px] font-[700] mb-5 ml-2 md:ml-0 mr-2 md:mr-0 slide-from-right">
          We Deliver Unmatched <span className="text-blue-700">Excellence</span>
        </h1>
        <p className="text-[18px] md:text-[20px] font-[300] leading-7 md:leading-10 ml-2 md:ml-0 mr-2 md:mr-0 mb-5 slide-from-bottom">
        ...
        <div className="flex flex-col items-start ml-2 md:ml-0 airiness">
